...
var useGas = {
	...
	initLoadData : function(){
			...
			$service.callAction({
					"viewid" : "com.sunnercn.dailydata.ConsumeGasController", //后台带包名的Controller名
					"action" : "consumeGasInit", //方法名,
					"params" : json, //自定义参数
