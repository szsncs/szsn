...
var consumable={
	...
	sumbitCallAction : function(json){//调用新增服务
		...
		callAction(consumable.viewid,"ListInit",json,"savecallBack");
	},
	delete:function(){
		var data = $cache.read("logininfo");
	...
	updateCallAction : function(json){//调用修改服务
		...
		callAction(consumable.viewid,"update",json,"updatecallBack");
	},
	commit : function(){
		var data = $cache.read("logininfo");
		var logininfo = JSON.parse(data);	
	...
	commitCallAction : function(json){//调用删除服务
		...
		callAction(consumable.viewid,"commit",json,"commitcallBack");
	},
	unCommit : function(){
		var data = $cache.read("logininfo");
		var logininfo = JSON.parse(data);	
	...
	unCommitCallAction : function(json){//调用删除服务
		...
		callAction(consumable.viewid,"unCommit",json,"unCommitcallBack");
	},
	...
	initAdd : function(){//新增初始化
		...
		callAction(consumable.viewid,"addInit",json,"addInitcallBack");
	},
