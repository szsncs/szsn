...
var notApprInfo = {
	...
	initLoadData:function(pk_total_info_h){
		...
		$service.callAction({
			"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
			"action" : "initSilverskinInfo", //方法名,
			"params" : json, //自定义参数
	...
	delete:function(){
		...
		if (pk_total_info_h && pk_total_info_h.length>0){
			...
			$service.callAction({
				"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
				"action" : "deleteSilverskinTotal", //方法名,
				"params" : json, //自定义参数
	...
	submit:function(){
		...
		if (pk_total_info_h && pk_total_info_h.length>0){
			...
			$service.callAction({
				"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
				"action" : "submitSilverskinTotal", //方法名,
				"params" : json, //自定义参数
	...
	unSubmit:function(){
		...
		$service.callAction({
			"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
			"action" : "unSubmitSilverskinTotal", //方法名,
			"params" : json, //自定义参数
	...
	apply:function(){
		...
		if(array.length > 0){
			...
			$service.callAction({
				"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
				"action" : "applySilverskinTotal", //方法名,
				"params" : json, //自定义参数
	...
	update:function(){
		...
		if(array.length > 0){
			...
			$service.callAction({
				"viewid" : "com.sunnercn.silverskin.SilverskinApplyController", //后台带包名的Controller名
				"action" : "updateSilverskinTotal", //方法名,
				"params" : json, //自定义参数
